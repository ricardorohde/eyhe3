...
<html class="html" lang="pt-BR">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Recuperar Senha do Anjo | EYHE - Conversas acolhedoras em minutos</title>
    ...
    <body class="body">
                                ...
                                <div class="row">
                                    <div class="col-12 blue">
                                        <div class="text-primary p-4">
                                            <h5 class="text-primary">Olá Anjo, esqueceu a senha?</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body pt-0">
                                ...
                                <div class="p-2">
                                    <div class="alert alert-success text-center mb-4" role="alert">
                                        Digite seu e-mail. Você receberá um código por <b>SMS</b>
                                    </div>
                                    <form class="form-horizontal" method="post" id="recuperar-senha-anjo">

                                        <div class="form-group">
                                            <input type="email" required name="email" class="form-control" placeholder="E-mail usado para fazer login">
                                        </div>
                                        <div class="form-group row mb-0">
                                            <div class="col-12 text-right">
                                                <button class="btn btn-primary w-md waves-effect waves-light" type="submit">Recuperar minha senha</button>
                                            </div>

                                            <br/>
                                            <center>
                                              <p>Caso você não receba o código, entre em contato com a Equipe Eyhe para conferir seu celular </p>
                                            </center>
                                        </div>
        ...
        <script>
        jQuery('#recuperar-senha-anjo').submit(function() {
            var dados = $('#recuperar-senha-anjo').serialize();

            jQuery.ajax({
                type: "POST",
                cache: false,
                url: "painel/engine/gera_code_recuperar_senha_anjo.php",
                data: dados,
                beforeSend: function() {
                  Swal.fire({
                   title: 'Aguarde um instante..',
                   text: 'Estamos enviando um código por SMS',
                ...
                success: function(data) {
                     if (data == 'Código enviado!') {
                        ...
                        setTimeout(function() {
                            window.location.href = 'codigo.php?'+dados;
                        }, 2000);
                    } else {
                      Swal.fire({
                        icon: 'error',
