 ...
 <?php
  ...
  //verificação se é o primeiro atendimento pago entre esse heroi e anjo
  $tipo = 'recorrente';
  $consulta = $conexao->prepare("SELECT status FROM pagamentos WHERE idheroi = :idheroi AND idanjo = :idanjo LIMIT 1");
  $consulta->bindParam(':idheroi', $_GET['myid'], PDO::PARAM_INT);
  $consulta->bindParam(':idanjo', $idother, PDO::PARAM_INT);
  $consulta->execute();
  while ($linha = $consulta->fetch(PDO::FETCH_ASSOC)) {
    if($linha['status'] == 'Pagamento confirmado'){
      $tipo = 'recorrente';
    }
  }
...
<head>
    ...
    })(window,document,'script','dataLayer','GTM-THMMKSX');</script>
    <!-- End Google Tag Manager -->

    <!-- Google Tag Manager (noscript) -->
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-THMMKSX"
    ...
    <nav class="navigation">
        <div class="nav-group">
            <ul>
                <li class="logo">
                    ...
                    <center>
                      <a href="../dashboard.php">
                        <img src="https://www.eyhe.com.br/img/logotipo_azul.png" width="100px;" />
                      </a>
                    </center>
                    <br/>
                </li>
                ...
                <li>
                    <a  id="dashboard" href="../dashboard.php" data-toggle="tooltip"
                ...
                <li class="brackets">
                    <a  id="blog" href="../blog.php" target="_blank" data-toggle="tooltip"
    ...
    <div class="content">
        ...
        <div class="chat">
            <div class="chat-header">
                <div class="chat-header-user">
                    ...
                    <div>
                        ...
                        <?php
                                ...
                                echo "<small class='text-success' id='status_digitando'>
                                        <i>Disponível</i>
                                    </small>";
                ...
                <div class="chat-header-action">
                    <ul class="list-inline">
                        ...
                        <li class="list-inline-item animated infinite pulse slower btn_pagamento_efetuado" data-toggle="tooltip" title="Aproveite :D">
                            <a href="#" class="btn btn-success">
                                Aproveite seu atendimento premium :)
                            </a>
                        </li>
            ...
            <div class="barra-status-sucesso" >
              Pagamento Confirmado. Aproveite seu atendimento :)
            </div>
            <div class="barra-status-aguardando">
              Pagamento em aguardo. Realize o pagamento para continuar.
            </div>
            <div class="barra-status-problemas">
              Pagamento com problemas. Peça ajuda ao seu Anjo.
            </div>
            <div class="barra-status-10minutos">
              Você está utilizando os 10 minutos gratuitos. Logo a solicitação de pagamento aparecerá.
            </div>
        ...
        <div class="sidebar-group">
                    ...
                    <div class="pl-4 pr-4">
                        <div class="text-center">
                            ...
                            <?php if($premium == 1){
                                ...
                                if($tipo == 'novo'){
                                  echo"<small class='text-muted font-italic'>Anjo Premium com desconto por ser primeiro atendimento. Valor de retribuição por 40 minutos de atendimento: R$19,95</small>";

                                }else{

                                  echo"<small class='text-muted font-italic'>Anjo Premium. Valor de retribuição por 40 minutos de atendimento: R$".$valor.",90</small>";
                                }
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                ...
                                <br/><br/>
                                <a id="btn-sessao-video" style="color: #fff!important"> Começar atendimento por vídeo </a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div id="pagamento" class="sidebar">
                ...
                <div class="sidebar-body">
                    <div class="pl-4 pr-4">
                        ...
                        <?php
                            if($tipo == 'novo'){
                              echo "<h5>Preencha seus dados :)</h5>
                                    <p>Você está pagando <b>R$19,95 por seu primeiro atendimento de 40 minutos</b>.";
                            }else{
                              echo "<h5>Preencha seus dados :)</h5>
                                    <p>Você está pagando <b>R$".$valor.",90 por 40 minutos </b> de conversa ativa e acolhedora.</p>";
                            }
                      ...
                      <form id="payment-form" action="" method="POST">
                          ...
                          <input type="hidden" id="valor" name="valor" value="14.90"/>
                          ...
                          <div class="form-group">
                            ...
                            <a href='#' id="ativar_cupom"><u>ativar cupom!</u></a>
                          </div>


                          <div class="alert alert-success alert-dismissible fade show cupom-25-off" role="alert" style="display: none;">
                            <strong>Cupom validado! </strong> Você ganhou 25% de desconto. Novo valor: R$11,20
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
                            </button>
                          </div>

                          <div class="alert alert-warning alert-dismissible fade show cupom-erro" role="alert" style="display: none;">
                            <strong>Cupom inválido! </strong> Tente novamente ou entre em contato com o suporte Eyhe
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
                            </button>
                          </div>
                          ...
                          <center>
                            ...
                            <button type="submit" class="btn btn-primary btn-lg" id="pagar">Pagar e voltar ao atendimento</button></br><br/>
                ...
                <div class="sidebar-body">
                    <div class="pl-4 pr-4">
                        <div class="text-center">
                            ...
                            <?php
                                if($tipo == 'novo'){
                                  echo "<p><b>Em troca, você dará um suporte financeiro de 19,95 e a gratidão que existe no seu coração.";
                                }else{
                                  echo "<p><b>Em troca, você dará um suporte financeiro de 14,90 e a gratidão que existe no seu coração.";
                                }
            ...
            <div id="avalie" class="sidebar">
                ...
                <div class="sidebar-body">
                    <div class="pl-4 pr-4">
                        <div class="text-center">
                          <figure class="avatar avatar-xl mb-4" style="width: 40px; height: 40px;">
                              <img src="../painel/<?php echo $avataranjo; ?>" class="rounded-circle" alt="image">
                          </figure>
...
$("#ultimas_conversas").click(function() {
   alert('oi');
...
$("#blog").click(function() {
    ...
    function dispara_inicio_do_atendimento(){
        ...
        toastr["info"]("Você tem 10 minutos grátis para conhecer o Anjo! Aproveite, aqui você está seguro.");
    ...
    function dispara_re_atendimento(){
        ...
        //vou disparar um toastds com 7 min.
        setTimeout( function() {
          toastr["info"]("Caso deseje renovar o atendimento, clique no botão 'Efeutar Pagamento' que surgira em sua tela nos próximos instantes.");
        }, 5000 );
    ...
    function detector_de_conversa_ativa(){
      ...
      $.ajax({
        ...
        //dataType: 'json', //Definimos o tipo de retorno
        data: {"nome_tabela": '<?php echo $tabela; ?>',
               "idheroi": '<?php echo $_GET['myid']; ?>',
               "idanjo": '<?php echo $idother; ?>'},
...
<script>
    /* OUVINDO SINAL DO DIGITANDO */
    var status_t = "<?php echo $status_t; ?>";

    session.on('signal:digitando', function signalCallback(event) {
      $('#status_digitando').text("digitando..");
    });

    session.on('signal:parou-de-digitar', function signalCallback(event) {
      $('#status_digitando').text(status_t);
    ...
    //montando a url do video
      var url_sessao_de_video = 'https://eyhe.com.br/video/index.php?apiKey='+apiKey+'&sessionId='+sessionId+'&token='+token;

    //redirecionando caso o botao seja clicado
      $( "#btn-sessao-video" ).click(function() {
           window.open(url_sessao_de_video, '_blank');
      });

      $( "#ativar_cupom" ).click(function() {
           var codigo_cupom = $("#cupom").val();
           //alert("Cupom digitado: "+codigo_cupom);

           //ajax para validar cupom!
           jQuery.ajax({
                type: "POST",
                url: "../painel/engine/valida_cupom.php",
                data: {cupom : codigo_cupom },
                beforeSend: function(){
                },
                success: function(data)
                {
