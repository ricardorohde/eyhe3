                        ...
                        <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
                            <div class="card-body accordion" id="accordionInter" >
                                ...
                                <!--<div class="card-header">
                                    <a class="deb btn btn-white" id="debito" href="">Cartão de Débito</a>
                                </div>-->
                                <div class="card-header">
                ...
                <div class="divbox" id="divbox">
                    <div class="boxintro">
                        <div class="card one" id="card1">
                            ...
                            <!--<a class="deb btn btn-white" href="">Cartão de Débito</a>-->
                            <a class="bol btn btn-white" href="boleto.php">Boleto Bancário</a>
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    ...
                                    <div class="text-muted">
                                        ...
                                        <div>
                                            <a href="" class="btn btn-white">Histórico de Pagamentos</a>
                                        </div>
