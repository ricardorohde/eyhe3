                      ...
                      <li>
                          <div class="uk-panel painel_anjo">
                              <a href="perfil_anjo.php?q=<?php echo $linha['id'] ?>">
                                ...
                                <p> <svg height="10" width="10"><circle cx="4" cy="4" r="4" fill="red" />  </svg> Offline</p>
                                <!--<p> <svg height="10" width="10"><circle cx="4" cy="4" r="4" fill="green" />  </svg> Online</p>-->
                              </a>
                              <br/>
                              <p class="ultimo_texto texto_perfil_anjo"><?php echo  substr($linha['biografia'],0,250); ?>...</p>
                            
                              <br>
                              <div uk-grid class="uk-grid-small uk-child-width-1-2 uk-grid-divider interesses">
                                <div>
                                  <h5 class="uk-align-right">Desafios</h5>
                                  <p class="legendas uk-text-nowrap uk-align-right  uk-text-right">
                               ...
                               <div>
                                  <h5 class="uk-align-left">interesses</h5>
                                  <p class="legendas uk-text-nowrap uk-align-left">
                              ...
                              <?php
                                ...
                                if (in_array($linha['id'], $anjos_do_chat)){
                                  ...
                                  echo "<a class='uk-button uk-button-default botao_roxo' href='chat.php?myid=$meuid&idanjo=$idanjo&room=$sessao&where=$tabela'>Retomar</a>";
                                }else{
                                  ...
                                  //aqui vai ter um form que manda para o ajax
                                  echo "<a class='uk-button uk-button-default botao_roxo gerar_chat' data-id='$meuid-$idanjo'>Conversar</a>";
                                }
                              ?>
                            <br>
                            
                              <a class="uk-button uk-button-default botao uk-margin-small-top" href="perfil_anjo.php?q=<?php echo $linha['id'] ?>"  style="margin-bottom: 15px;">Ver Perfil</a>
                          </div>
                      </li>
                      <?php } ?>
                  </ul>
