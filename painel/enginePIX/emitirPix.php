...
$tamanhoQrCode = "300"; // Insira o tamanho em pixels do QR Code que será gerado. Obs: Tamanho deve ser m sou igual a 256px
...
$cidade = "Pato Branco - PR"; // [obrigatório] cidade onde é efetuada a transação

$cep = "85501-020"; // [opcional] CEP da localidade onde é efetuada a transação
...
$body = [
  "calendario" => [
    "expiracao" => 604800 // [opcional] Tempo de vida da cobrança, especificado em segundos a partir da data de criação. Caso não definido o padrão será de 86400 segundos ( 24 horas)
  ],
  "devedor" => [
    "cpf" => $cpf, // [opcional] CPF do usuário pagador.string /^\d{11}$/
    //"cnpj" => "12345678000123",
    "nome" => $nome_heroi // [opcional] Nome do usuário pagador. Máximo: 25 caracteres.
  ],
  "valor" => [
    "original" => $valor // [obrigatório] Valor original da cobrança.string \d{1,10}.\d{2} Obs: Para QR Code dinâmico, valor mínimo é de 0.01. Para QR Code poderá ser 0.00 (Ficará aberto para o pagador definir o valor)
  ],
  "chave" => $configuracoes["chave"], // [obrigatório] Determina a chave Pix registrada no DICT que será utilizada para a cobrança.
  "solicitacaoPagador" => $especificacao // [opcional] determina um texto a ser apresentado ao pagador para que ele possa digitar uma informação correlata, em formato livre, a ser enviada ao recebedor.
