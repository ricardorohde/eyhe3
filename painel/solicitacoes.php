            ...
            ?>
                  <div class="card bg-white">
                    <div class="card-header">
                        SOLICITAÇÃO <b> <?php echo $linha['nome']; ?> </b>
                    </div>
                    <div class="card-block">
                      <div class="row m-a-0">
                        <div class="col-lg-12">
                          <p><b>Nome do anjo:</b> <?php echo $linha['nome']; ?></p>
                          <p><b>Data da solicitação:</b> <?php echo date('d/m/Y H:i:s', strtotime($linha['datacadastro'])); ?></p>
                          ...
                          <p><b>Fale brevemente como você vive hoje:</b><br/> <?php echo $linha['pergunta1']; ?></p>
                          <p><b>Qual o maior e mais difícil desafio você teve que enfrentar e como superou isso?</b><br/> <?php echo $linha['pergunta2']; ?></p>
                          <p><b>Cite os momentos que mais te deixam feliz no dia a dia:</b><br/> <?php echo $linha['pergunta3']; ?></p>
                          <p><b>Qual o papel que a fé desempenha em sua vida?</b><br/> <?php echo $linha['pergunta4']; ?></p>
                          <p><b>Qual é o valor/princípio pessoal mais importante para você?</b><br/> <?php echo $linha['pergunta5']; ?></p>
                          <p><b>Porque você gostaria de ser um anjo Eyhe? </b><br/> <?php echo $linha['pergunta6']; ?></p>
