<?php
  include "../chat/scripts_g/PHP/verifica_sessao.php";
...
<head>
    ...
    <meta name="copyright" content="frontendmatters">
     <meta name="revised" content="Friday, October 30th, 2020, 10:15 am" />-->
    <title>Chat Eyhe | Em atendimento com: <?php echo $nomeanjo; ?></title>
    ...
    <script src='https://www.eyhe.com.br/js/opentok.min.js'></script>
...
<body class="chats-tab-open">
    ...
    <div class="main-layout">
        ...
        <!-- Sidebar Start na versao heroi o display disso é none -->
                ...
                <div class="chat-body">
                    ...
                    <div class="chat-header">
                        ...
                        <div class="media chat-name align-items-center text-truncate">
                            <div class="avatar avatar-online d-none d-sm-inline-block mr-3">
                                <img src="../painel/<?php echo $avataranjo;?>" alt="">
                            </div>

                            <div class="media-body align-self-center ">
                                <h6 class="text-truncate mb-0"><?php echo $nomeanjo;?></h6>
                    ...
                    <div class="chat-content p-2">
                        <div class="container">
                            ...
                            <!-- Message Day Start -->
                            <div class="message-day" id="messageBody">
                    ...
                    <div class="chat-footer">
                        ...
                        <form id="input-chat" action="">
                          <textarea id="messageInput" class="form-control emojionearea-form-control" name="msgTxt" rows="3" placeholder="Digite seu mensagem.."></textarea>
                          <input id="myID" name="myID" type="hidden" value="<?php echo $myID; ?>"/>
                          <input id="tabela" name="tabela" type="hidden" value="<?php echo $tabela; ?>"/>
                          <button class="btn btn-primary btn-icon send-icon rounded-circle text-light mb-1" role="button" type="submit" id="btn_submit">
                              <svg class="hw-24" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <!--<script id="mustache-template">
      //para usar a variavel é só chamar {{texto}}
      var mensagem = {
        'texto': '"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."',
        'datahora': '22:40 08/09/20',
        'avatar': 'assets/media/avatar/2.png'
      }
      ...
      output_2 = Mustache.render('<div class="message self"><div class="message-wrapper"><div class="message-content"><span>{{texto}}</span></div></div><div class="message-options"><div class="avatar avatar-sm"><img alt="" src="{{avatar}}"></div><span class="message-date">{{datahora}}</span></div></div>', mensagem);
      //$('#messageBody').append(output);
      //$('#messageBody').append(output_2);

      //e um digitando legalzinho?
