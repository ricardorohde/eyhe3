...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Eyhe Suporte Emocional</title>
        ...
        <link rel="stylesheet" href="assets/css/invisivel.css" />
    </head>
                                    ...
                                    <div class="col-md-4">
                                        <div class="conteudos">
                                            <div class="ctn d-flex">
                                                <div class="col-md-6">
                                                    <picture class="last">
                                                        <source type="image/png" src="assets/images/Untitled.png" />
                                                ...
                                                <div class="col-md-6">
                                                    <picture class="last">
                                                        <source type="image/png" src="assets/images/Untitled2.png" />
                                                        <img src="assets/images/Untitled2.png" />
                                                    </picture>
                                                    <p>Saiba como aliviar a ansiedade em meio ao isolamento social.</p>
                                                    <a href="#" class="btn btn-blue">Ver tudo <i class="fas fa-arrow-right"></i></a>
                                                </div>
                    ...
                    <div class="d-flex">
                                ...
                                <div class="col-sm-12 d-flex">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="dint">
                                            ...
                                            <p>Seu agendamento com o ANjo Gabriel foi confirmado. deixe sua mensagem.</p>
                                            <p><i class="far fa-clock"></i> 3 min.</p>
                                        </div>
                                    </div>
                                    <div class="d-flex justify-content-between">
                                        <picture style="width:13px;height:13px;">
                                            <source type="image/png" src="assets/images/money-bag.png" />
                                            <img src="assets/images/money-bag.png" width="100%;" />
                                        </picture>
                                        <div class="dint">
                                            <p><strong>Saldo recebido</strong></p>
                                            <p>Recibo de R$14,90 confirmado.</p>
                                            <p><i class="far fa-clock"></i> 7 min.</p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="dropdown d-inline-block">
                            ...
                            <div class="dropdown-menu dropdown-menu-right status">
                                ...
                                <a class="dropdown-item" href="avaliacoes.php"><i class="far fa-star font-size-16 align-middle mr-1"></i>Avaliações</a>
