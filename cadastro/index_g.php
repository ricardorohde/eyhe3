...
<form class="resposta_pergunta needs-validation" id="form-cadastro" method="post" action="none">
            <div class="row">
                ...
                <div class="col-md-12 mb-3">
                    <input placeholder="Qual é seu nome?" class="form-control text-center" type="hidden" name="nome_completo" required value="<?php echo $g_nome;?>">
                </div>

                <div class="col-md-12 mb-3">
                    <input placeholder="Qual é seu e-mail?" autocomplete="off" class="form-control text-center" type="hidden" name="email" required value="<?php echo $g_email;?>">
                </div>
