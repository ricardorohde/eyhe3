      ...
      <div id="menu-escondido" uk-offcanvas="flip: true; overlay: true">
        ...
        <div class="uk-section uk-section-default uk-animation-fade" style="display: block;" id="pergunta_idade">
            <div class="uk-container uk-container-small uk-text-middle uk-text-center" style="width: 60%;">
                <h1>Esse e-mail não existe em nossos registros :(</h1>
                <h2>Tente novamente ou se preferir envie um e-mail para suporte@eyhe.com.br</h2>
                <form method="get" action="confirmar.php">
                    <div class="uk-margin uk-text-left">
                      <br/><br/>
                      <input class="uk-input" type="email" required name="email" placeholder="E-mail válido utilizado no cadastro">
                    </div>
                <br/>
                <div>
                    <br/>
