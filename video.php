        ...
        <div class="page-content">
            <div class="container-fluid video">
                <div class="row">
                    ...
                    <div class="mid">
                        <p class="h5"><strong>Convide o Herói para a chamada.</strong></p>
                        <p class="texto">Compartilhe este link da video chamada para o Herói participar.</p>
                        <div class="input d-flex">
                            <input id="txt" type="text" name="text" />
                            <picture class="d-flex">
                                <source type="image/webp" src="assets/images/icon_video/copy.webp">
                                <source type="image/svg" src="assets/images/icon_video/copy.svg">
                                <img src="assets/images/icon_video/copy.svg" />
                            </picture>
                        </div>
                        <a class="btn btn-green">
                            <picture>
                                <source type="image/webp" src="assets/images/icon_video/forward.webp" />
                                <source type="image/svg" src="assets/images/icon_video/forward.svg" />
                                <img src="assets/images/icon_video/forward.svg" />
                            </picture>
                            Enviar convite
                        </a>
                    </div>
