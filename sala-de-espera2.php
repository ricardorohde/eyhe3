                ...
                <div class="container-fluid" id="margin">
                    <div class="row diferentona">
                        <div class="card esp2" id="esp2">
                            <div class="txt">
                                <p class="h5">Sua vez está chegando</p>
                                <p class="two">Você está em uma <strong>sala de espera virtual</strong> e será rapidamente atendido, aguarde:</p>
                            </div>
                            <picture>
                                <source type="image/webp" src="assets/images/form/imagem1.webp" />
                                <source type="image/png" src="assets/images/form/imagem1.png" />
                                <img src="assets/images/form/imagem1.png" />
                            </picture>
                            <div>
                                <a href="#" id="search">
                                ...
                                <p>Notificamos nossos Anjos Online, <strong>você será atendido dentro de 5 min.</strong></p>
                            </div>
                        </div>
                        <div class="col-sm-4 col-md-4" id="md4">
                            <p class="h5" style="margin-bottom: 20px;"><i class="fas fa-search"></i> Anjos Disponíveis</p>
                            ...
                            <a href="#" class="btn btn-blue">Buscar outros Anjos</a>
                        </div>
                    </div>
                </div>
            </div>
