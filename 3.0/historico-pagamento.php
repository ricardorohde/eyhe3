...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="assets/css/historico-pagamento.css" />
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-centered table-nowrap mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="dez"><a href="javascript: void(0);" class="text-body font-weight-bold">#SK2540</a> </td>
                                            <td class="dez7">Neal Matthews</td>
                                            <td class="dez">
                                                07 Oct, 2019
                                            </td>
                                            <td class="dez">
                                            ...
                                            <td class="dez7">
                                                <span class="badge badge-pill badge-soft-success font-size-12">Pago</span>
                                            </td>
                                            <td class="dez7">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge badge-pill badge-soft-danger font-size-12">Negado</span>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge badge-pill badge-soft-warning font-size-12">Reembolso</span>
                                            </td>
                                            <td>
                                                <i class="fab fa-cc-visa mr-1"></i> Visa
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" style="left: -100px !important;" aria-labelledby="dropdownMenuButton">
                                                        <a class="dropdown-item" href="#">Alguma ação</a>
                                                        <a class="dropdown-item" href="#">Outra ação</a>
                                                        <a class="dropdown-item" href="#">Alguma coisa aqui</a>
                                                    </div>
