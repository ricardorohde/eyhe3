...
<div class="main-content">
    <div class="page-content">
        <div class="container-fluid dont yes">
            <div class="row justify-content-center">  
                <div class="py-4 border-bottom concluidas" id="py4">
                    <div class="media d-flex justify-content-center align-items-center">
                        <p class="h5">Concluídas</p><i class="fas fa-chevron-down"></i>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="l1">
                                    ...
                                    <div class="dropdown">
                                        <a class="btn btn-primary btn-green-white dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <p>Editar</p>  <i class="bx bx-chevron-down"></i></a>
