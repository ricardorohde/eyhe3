...
<html lang="en">
    ...
    <?php include "../tagmanagerhead.php"; ?>
        ...
        <link rel="stylesheet" href="../assets/css/chatt_new.css" />
...
<div class="main-content">
    <div class="page-content">
        <div class="container-fluid chat">
            ...
            <div id="cupom" class="card cupom">
                <div id="close7"><i class="fas fa-times"></i></div>
                <p>Preencha a porcentagem do desconto que deseja:</p>
                ...
                <p>Envie para seu Herói o código:</p>
                <p><strong><u>CUPOM25</u></strong></p>
                <a class="btn btn-blue">Copiar Cupom</a>
            </div>
                        ...
                        <div class="col-md-8 col-3">
                            <ul class="list-inline user-chat-nav text-right mb-0">
                                ...
                                <div class="dropdown-menu" id="chatdrop" aria-labelledby="dropdownMenuLinkChat">
                                  ...
                                  <a id="enviar" class="dropdown-item" href="#">
                                      <picture>
        ...
        <a class="btn btn-blue" type="button" data-toggle="modal" data-target="#exampleModalCenter">Modal</a>
            <!-- Modal -->
            <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Você ganhou um cupom de desconto!!</h5>
                ...
                <div class="modal-body d-flex flex-column align-items-center justify-content-center">
                    <picture>
                        <source type="image/webp" src="../assets/images/email/presente.webp" />
                        <source type="image/png" src="../assets/images/email/presente.png" />
                        <img src="../assets/images/email/presente.png" />
                    </picture>
                    <p class="cupom"><strong>CUPOM25</strong></p>
                    <p class="p">Você ganhou 25% off na conversa. Utilize: <strong>"CUPOM25"</strong> na hora do pagamento e aproveite!</p>
                </div>
                <div class="modal-footer d-flex justify-content-center">
                    <a class="btn btn-green">Copiar Código</a>
                </div>
                </div>
            </div>
            </div>
